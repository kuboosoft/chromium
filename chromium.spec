...
# widevine support
cp -f out/Release/{*.pak,*.bin,libwidevinecdmadapter.so} %{buildroot}%{_libdir}/%{name}/
#
...
* Thu Jun 16 2016 David Vásquez <davidjeremias82 AT gmail DOT com> - 51.0.2704.84-3
- Enable widevine support
- Updated to 51.0.2704.84
- Added missed dependency libatomic
- Upstream
